...
public class StandardLevelConfigBuilder implements LevelConfigBuilder {
    ...
    @Override
    public LevelConfigBuilder setDarkLevel(boolean isDark) {
        configBuilder.darkLevel(isDark);
        return this;
    }

    @Override
    public LevelConfigBuilder setSwarmWarning(boolean isSwarm) {
        configBuilder.swarmWarning(isSwarm);
        return this;
    }
